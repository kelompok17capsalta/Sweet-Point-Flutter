...
class ApiPaket {
  Future<DataPaket> getDataPaket() async {
    try {
      Response response =
          await Dio().get('http://54.84.135.87/v1/product/paketdata');
...
class ApiCashOut {
  Future<DataCashOut> getDataCashOut() async {
    try {
      Response response =
          await Dio().get('http://54.84.135.87/v1/product/cashout');
...
class ApiPulsaa {
  Future<DataPulsaa> getDataPulsaa() async {
    try {
      Response response =
          await Dio().get('http://54.84.135.87/v1/product/pulsa');
...
class ApiEmoney {
  Future<DataEmoney> getDataEmoney() async {
    try {
      Response response =
          await Dio().get('http://54.84.135.87/v1/product/emoney');
